...
AddPackage cups-browsed # a helper daemon to browse the network for remote CUPS queues and IPP network printers
...
AddPackage networkmanager-openconnect # NetworkManager VPN plugin for OpenConnect (with GUI)
